...
VALUES
  -- 用户1的学习相关任务
  ('task-001', '学习 React', '学习React基础和进阶内容，包括组件、状态管理等', false, 2, '2025-09-16 12:00:00', '2025-09-22', NULL, 0, 'todolist-001', 'group-001', 'user-001', NOW(), NOW()),
  ('task-002', 'Sub 学习 React1', 'React组件生命周期和Hooks学习', false, 2, '2025-09-16 12:00:00', '2025-09-30', 'task-001', 1, 'todolist-001', 'group-001', 'user-001', NOW(), NOW()),
  ('task-003', 'Sub 学习 React2', 'React路由和状态管理学习', false, 2, '2025-09-16 12:00:00', '2025-09-18', 'task-001', 1, 'todolist-001', 'group-001', 'user-001', NOW(), NOW()),
  ('task-004', 'Sub 学习 React3', 'React性能优化和最佳实践', false, 2, '2025-09-16 12:00:00', '2025-09-18', 'task-001', 1, 'todolist-001', 'group-001', 'user-001', NOW(), NOW()),
  ('task-005', '刷完《React 进阶实战》视频课', '完成10小时的React进阶实战视频课程', false, 2, '2025-09-16 12:00:00', '2025-09-20', NULL, 0, 'todolist-001', 'group-002', 'user-001', NOW(), NOW()),
  ('task-006', '整理个人知识库', '将学习资料分类整理，建立知识体系', false, 1, '2025-09-16 12:00:00', '2025-09-25', NULL, 0, 'todolist-001', 'group-002', 'user-001', NOW(), NOW()),
  ('task-007', '学习 TypeScript 高级特性', '学习泛型、类型守卫、装饰器等高级特性', false, 3, '2025-09-16 14:00:00', '2025-09-28', NULL, 0, 'todolist-001', 'group-001', 'user-001', NOW(), NOW()),
  
  -- 用户1的工作相关任务
  ('task-008', '完成需求评审', '与团队讨论并确定项目需求和范围', true, 1, '2025-09-16 12:05:00', '2025-09-14', NULL, 0, 'todolist-002', 'group-003', 'user-001', NOW(), NOW()),
  ('task-009', '编写API文档', '使用Swagger为后端API编写详细文档', false, 2, '2025-09-17 10:00:00', '2025-09-20', NULL, 0, 'todolist-002', 'group-003', 'user-001', NOW(), NOW()),
  ('task-010', '准备周会材料', '收集项目进度，准备周会汇报内容', false, 1, '2025-09-17 15:00:00', '2025-09-18', NULL, 0, 'todolist-002', 'group-004', 'user-001', NOW(), NOW()),
  ('task-011', '代码审查', '审查团队成员提交的代码，确保质量', false, 2, '2025-09-18 09:00:00', '2025-09-19', NULL, 0, 'todolist-002', 'group-004', 'user-001', NOW(), NOW()),
  ('task-012', '团队培训会议', '组织技术分享会，提升团队技能', false, 1, '2025-09-20 14:00:00', '2025-09-20', NULL, 0, 'todolist-002', 'group-003', 'user-001', NOW(), NOW()),
  
  -- 用户2的任务
  ('task-013', '购买生日礼物', '为朋友挑选生日礼物并包装', true, 1, '2025-09-15 18:00:00', '2025-09-15', NULL, 0, 'todolist-003', 'group-005', 'user-002', NOW(), NOW()),
  ('task-014', '打扫房间', '打扫客厅、卧室和厨房，保持整洁', false, 2, '2025-09-17 10:00:00', '2025-09-17', NULL, 0, 'todolist-003', NULL, 'user-002', NOW(), NOW()),
  ('task-015', '读完《代码整洁之道》', '阅读并理解代码整洁之道的核心原则', false, 3, '2025-09-16 09:00:00', '2025-09-30', NULL, 0, 'todolist-004', 'group-006', 'user-002', NOW(), NOW()),
  ('task-016', '做读书笔记', '整理《代码整洁之道》的关键知识点和感悟', false, 2, '2025-09-19 15:00:00', '2025-09-25', 'task-015', 1, 'todolist-004', 'group-006', 'user-002', NOW(), NOW()),
  ('task-017', '计划下本月阅读书单', '根据兴趣和需求，制定下个月的阅读计划', false, 1, '2025-09-25 10:00:00', '2025-09-28', NULL, 0, 'todolist-004', 'group-006', 'user-002', NOW(), NOW()),
  
  -- 用户3的任务
  ('task-018', '跑步5公里', '在公园完成5公里跑步锻炼', false, 2, '2025-09-17 07:00:00', '2025-09-17', NULL, 0, 'todolist-005', 'group-007', 'user-003', NOW(), NOW()),
  ('task-019', '健身训练', '进行力量训练，重点锻炼上肢', false, 3, '2025-09-18 18:00:00', '2025-09-18', NULL, 0, 'todolist-005', 'group-007', 'user-003', NOW(), NOW()),
  
  -- 用户1的旅行计划任务
  ('task-020', '预订机票', '查询并预订往返机票，比较价格和时间', false, 2, '2025-09-20 10:00:00', '2025-09-25', NULL, 0, 'todolist-006', 'group-008', 'user-001', NOW(), NOW()),
  ('task-021', '预订酒店', '根据行程安排预订合适的酒店住宿', false, 2, '2025-09-22 10:00:00', '2025-09-27', NULL, 0, 'todolist-006', 'group-008', 'user-001', NOW(), NOW()),
  ('task-022', '制定行程计划', '详细规划每天的行程安排和景点游览', false, 1, '2025-09-24 14:00:00', '2025-09-30', NULL, 0, 'todolist-006', 'group-008', 'user-001', NOW(), NOW()),
  
  -- 新增30条多层级任务数据（从task-023开始）
  -- 项目开发任务树（用户1）
  ('task-023', '前端项目重构', '对现有前端项目进行全面重构，提升性能', false, 3, '2025-10-01 10:00:00', '2025-10-20', NULL, 0, 'todolist-002', 'group-003', 'user-001', NOW(), NOW()),
  ('task-024', '技术栈选型', '评估并选择合适的前端技术栈和框架', false, 3, '2025-10-01 14:00:00', '2025-10-03', 'task-023', 1, 'todolist-002', 'group-003', 'user-001', NOW(), NOW()),
  ('task-025', '框架对比分析', '对React、Vue和Angular进行详细对比分析', false, 2, '2025-10-02 10:00:00', '2025-10-03', 'task-024', 2, 'todolist-002', 'group-003', 'user-001', NOW(), NOW()),
  ('task-026', '组件库评估', '评估多个UI组件库的适用性和功能', false, 2, '2025-10-02 14:00:00', '2025-10-04', 'task-024', 2, 'todolist-002', 'group-003', 'user-001', NOW(), NOW()),
  ('task-027', '架构设计', '设计前端项目的整体架构和模块划分', false, 3, '2025-10-04 10:00:00', '2025-10-08', 'task-023', 1, 'todolist-002', 'group-003', 'user-001', NOW(), NOW()),
  ('task-028', '目录结构规划', '规划项目的文件目录结构和命名规范', false, 2, '2025-10-04 14:00:00', '2025-10-05', 'task-027', 2, 'todolist-002', 'group-003', 'user-001', NOW(), NOW()),
  ('task-029', '状态管理方案', '选择并实现适合项目的状态管理方案', false, 2, '2025-10-05 10:00:00', '2025-10-07', 'task-027', 2, 'todolist-002', 'group-003', 'user-001', NOW(), NOW()),
  ('task-030', 'API接口设计', '设计前后端交互的API接口规范', false, 2, '2025-10-05 14:00:00', '2025-10-08', 'task-027', 2, 'todolist-002', 'group-003', 'user-001', NOW(), NOW()),
  ('task-031', '代码实现', '根据设计文档进行具体的代码实现', false, 2, '2025-10-09 09:00:00', '2025-10-18', 'task-023', 1, 'todolist-002', 'group-004', 'user-001', NOW(), NOW()),
  ('task-032', '核心组件开发', '开发项目所需的核心UI组件和业务组件', false, 2, '2025-10-09 10:00:00', '2025-10-15', 'task-031', 2, 'todolist-002', 'group-004', 'user-001', NOW(), NOW()),
  ('task-033', '用户界面实现', '根据设计稿实现用户界面和交互效果', false, 2, '2025-10-12 10:00:00', '2025-10-17', 'task-031', 2, 'todolist-002', 'group-004', 'user-001', NOW(), NOW()),
  ('task-034', '数据层对接', '实现前端与后端API的数据交互逻辑', false, 2, '2025-10-14 14:00:00', '2025-10-18', 'task-031', 2, 'todolist-002', 'group-004', 'user-001', NOW(), NOW()),
  ('task-035', '测试与优化', '对项目进行全面测试和性能优化', false, 3, '2025-10-19 10:00:00', '2025-10-20', 'task-023', 1, 'todolist-002', 'group-003', 'user-001', NOW(), NOW()),
  
  -- 学习计划任务树（用户1）
  ('task-036', '学习前端新技术', '了解和学习最新的前端技术和趋势', false, 2, '2025-10-01 09:00:00', '2025-10-30', NULL, 0, 'todolist-001', 'group-001', 'user-001', NOW(), NOW()),
  ('task-037', '学习Vue 3', '系统学习Vue 3框架的核心概念和用法', false, 2, '2025-10-02 10:00:00', '2025-10-15', 'task-036', 1, 'todolist-001', 'group-001', 'user-001', NOW(), NOW()),
  ('task-038', '安装开发环境', '搭建Vue 3的开发环境和项目脚手架', false, 1, '2025-10-02 14:00:00', '2025-10-03', 'task-037', 2, 'todolist-001', 'group-001', 'user-001', NOW(), NOW()),
  ('task-039', '基础语法学习', '学习Vue 3的模板语法、组件基础等', false, 2, '2025-10-03 10:00:00', '2025-10-07', 'task-037', 2, 'todolist-001', 'group-001', 'user-001', NOW(), NOW()),
  ('task-040', '组合式API实践', '深入学习和实践Vue 3的组合式API', false, 2, '2025-10-08 10:00:00', '2025-10-12', 'task-037', 2, 'todolist-001', 'group-001', 'user-001', NOW(), NOW()),
  ('task-041', '创建示例项目', '使用Vue 3创建一个完整的示例项目', false, 3, '2025-10-13 10:00:00', '2025-10-15', 'task-037', 2, 'todolist-001', 'group-001', 'user-001', NOW(), NOW()),
  ('task-042', '学习WebAssembly', '了解WebAssembly的基本概念和应用场景', false, 2, '2025-10-16 10:00:00', '2025-10-25', 'task-036', 1, 'todolist-001', 'group-001', 'user-001', NOW(), NOW()),
  ('task-043', '理论学习', '学习WebAssembly的工作原理和编译过程', false, 2, '2025-10-16 14:00:00', '2025-10-20', 'task-042', 2, 'todolist-001', 'group-001', 'user-001', NOW(), NOW()),
  ('task-044', '简单应用开发', '使用WebAssembly开发一个简单的应用实例', false, 3, '2025-10-21 10:00:00', '2025-10-25', 'task-042', 2, 'todolist-001', 'group-001', 'user-001', NOW(), NOW()),
  
  -- 生活任务树（用户2）
  ('task-045', '家庭大扫除', '对整个家庭进行全面的清洁和整理', false, 2, '2025-10-05 09:00:00', '2025-10-05', NULL, 0, 'todolist-003', 'group-005', 'user-002', NOW(), NOW()),
  ('task-046', '打扫客厅', '清洁客厅的地面、家具和窗户', false, 2, '2025-10-05 09:30:00', '2025-10-05', 'task-045', 1, 'todolist-003', 'group-005', 'user-002', NOW(), NOW()),
  ('task-047', '扫地', '使用吸尘器清洁客厅的地毯和角落', false, 1, '2025-10-05 09:30:00', '2025-10-05', 'task-046', 2, 'todolist-003', 'group-005', 'user-002', NOW(), NOW()),
  ('task-048', '拖地', '使用拖把清洁客厅的硬质地面', false, 1, '2025-10-05 10:30:00', '2025-10-05', 'task-046', 2, 'todolist-003', 'group-005', 'user-002', NOW(), NOW()),
  ('task-049', '打扫卧室', '整理和清洁所有卧室空间', false, 2, '2025-10-05 11:30:00', '2025-10-05', 'task-045', 1, 'todolist-003', 'group-005', 'user-002', NOW(), NOW()),
  ('task-050', '整理衣柜', '整理和分类衣柜中的衣物', false, 2, '2025-10-05 11:30:00', '2025-10-05', 'task-049', 2, 'todolist-003', 'group-005', 'user-002', NOW(), NOW()),
  ('task-051', '更换床单', '更换所有卧室的床单和枕套', false, 1, '2025-10-05 12:30:00', '2025-10-05', 'task-049', 2, 'todolist-003', 'group-005', 'user-002', NOW(), NOW()),
  ('task-052', '打扫厨房', '彻底清洁厨房的各个区域和电器', false, 3, '2025-10-05 13:30:00', '2025-10-05', 'task-045', 1, 'todolist-003', 'group-005', 'user-002', NOW(), NOW()),
  ('task-053', '清洗油烟机', '拆卸并清洗厨房油烟机的滤网和部件', false, 3, '2025-10-05 13:30:00', '2025-10-05', 'task-052', 2, 'todolist-003', 'group-005', 'user-002', NOW(), NOW()),
  ('task-054', '清洁灶台', '清洁厨房灶台和周围墙面', false, 2, '2025-10-05 14:30:00', '2025-10-05', 'task-052', 2, 'todolist-003', 'group-005', 'user-002', NOW(), NOW()),
  ('task-055', '整理冰箱', '清理和整理冰箱内的食物和物品', false, 2, '2025-10-05 15:30:00', '2025-10-05', 'task-052', 2, 'todolist-003', 'group-005', 'user-002', NOW(), NOW());
...
VALUES
  -- 用户1删除的任务
  ('bin-001', '旧任务 - 完成项目提案', '这是一个已删除的旧任务', true, 2, '2025-09-10 10:00:00', '2025-09-12', NULL, 0, 'todolist-002', 'group-003', 'user-001', '2025-09-10 10:00:00', '2025-09-11 15:00:00', '2025-09-13 09:30:00'),
  ('bin-002', '旧任务 - 团队会议记录', '记录讨论的要点和行动项', false, 1, '2025-09-05 14:00:00', '2025-09-06', NULL, 0, 'todolist-002', 'group-004', 'user-001', '2025-09-05 14:00:00', '2025-09-05 15:30:00', '2025-09-12 16:20:00'),
  ('bin-003', '已取消的学习任务', '由于时间冲突取消的学习计划', false, 3, '2025-09-08 09:00:00', '2025-09-09', NULL, 0, 'todolist-001', 'group-001', 'user-001', '2025-09-08 09:00:00', '2025-09-08 09:00:00', '2025-09-10 11:45:00'),
  
  -- 用户2删除的任务
  ('bin-004', '旧任务 - 购买日用品', '每周购物清单', true, 2, '2025-09-07 18:00:00', '2025-09-08', NULL, 0, 'todolist-003', NULL, 'user-002', '2025-09-07 18:00:00', '2025-09-07 19:30:00', '2025-09-11 09:15:00'),
  ('bin-005', '已完成的阅读任务', '《程序员修炼之道》阅读笔记', true, 3, '2025-09-01 10:00:00', '2025-09-05', NULL, 0, 'todolist-004', 'group-006', 'user-002', '2025-09-01 10:00:00', '2025-09-04 16:45:00', '2025-09-09 14:30:00'),
  
  -- 用户3删除的任务
  ('bin-006', '已完成的健身任务', '完成30天健身挑战', true, 2, '2025-09-01 07:00:00', '2025-09-05', NULL, 0, 'todolist-005', 'group-007', 'user-003', '2025-09-01 07:00:00', '2025-09-05 18:30:00', '2025-09-08 08:20:00'),
  ('bin-007', '取消的户外活动', '由于天气原因取消的徒步计划', false, 1, '2025-09-09 09:00:00', '2025-09-10', NULL, 0, 'todolist-005', NULL, 'user-003', '2025-09-09 09:00:00', '2025-09-09 09:00:00', '2025-09-09 11:30:00');
